...
ActiveRecord::Schema.define(version: 2020_05_20_064442) do
  ...
  create_table "premade_tasks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.text "content", null: false
    t.time "time"
    t.datetime "created_at", null: false
  ...
  create_table "routine_tasks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
